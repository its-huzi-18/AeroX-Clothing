...
//     `*[_type == "shirt"]{ _id, image, title, price, oldPrice, width, height, color, category }`
//   );
...
//                 <h3 className="border-l-2 border-[#9F9F9F] pl-2">{data.title}</h3>
//               </li>
//             </ul>
//           </nav>
...
//             {relatedProducts.filter(shirt => shirt.category === data.category).map((shirt) => (
