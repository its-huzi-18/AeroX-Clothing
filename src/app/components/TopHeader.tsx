...
const TopHeader = () => {
  return (
    <div className={`bg-[#eceff2] flex justify-between gap-16  px-9 py-2 items-center ${poppins.className}`}>
...
<Link href={"https://www.facebook.com/share/18cGgNKmv5/?mibextid=wwXIfr"} className="group relative w-7 h-7 flex justify-center items-center rounded-full transition-all duration-300">
...
<Link href={"https://www.instagram.com/aeroxwear/#"} className="group relative w-7 h-7 flex justify-center items-center rounded-full transition-all duration-300">
