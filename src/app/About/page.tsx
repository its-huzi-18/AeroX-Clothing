      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96">
            <Image
              src="/Images/model1.jpg" // Replace with your model image
              alt="Aerox Model"
              layout="fill"
              objectFit="cover"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="relative h-64 mb-4">
                <Image
                  src="/Images/faizan.jpg" // Replace with Faizan's image
                  alt="Faizan Nadeem"
                  layout="fill"
                  objectFit="cover"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="relative h-64 mb-4">
                <Image
                  src="/Images/huzaifa.jpg" // Replace with Huzaifa's image
                  alt="Huzaifa Wahab"
                  layout="fill"
                  objectFit="cover"
                  className="rounded-lg"
